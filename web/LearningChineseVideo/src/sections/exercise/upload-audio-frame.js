...
const UploadAudioFrame = ({ onUploadedVideo }) => {
  ...
  return (
    ...
    >
      {raw.hasLocalVideo ? (
        raw.uploading && !remoteVideo ? (
          ...
          >
            ...
            >
              ...
              <Box sx={{ width: "100%" }}>
                <Typography mb="5px" fontSize="14px" variant="subtitle2">
                  {raw.filename}
                </Typography>
                <LinearProgress
                  variant="determinate"
        ...
        >
          <Typography fontSize="22px" fontWeight="600" variant="subtitle2">
            Tải file audio
          </Typography>
          <Typography fontSize="14px" variant="subtitle2">
            Bấm vào đây để tải audio từ máy của bạn
          </Typography>
          <Button
...
export default UploadAudioFrame;
